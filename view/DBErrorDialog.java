...
public class DBErrorDialog extends JDialog {
	...
	public DBErrorDialog() {
		...
		getContentPane().setLayout(new BorderLayout(0, 0));
		{
			...
			{
				JLabel msg1 = new JLabel("Der var en fejl i kommunikationen med databasen!");
				msg1.setFont(new Font("Arial", Font.PLAIN, 20));
				contentPanel.add(msg1);
			}
			{
				JLabel msg2 = new JLabel("Prøv at trykke på reset og scan kortet igen.");
